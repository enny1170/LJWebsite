//PoCo with LazyLoader Support created by Template on 26.10.2018 07:02:05
using System;
...
{
    public class FixtureFunctionValue
    {
        protected readonly Action<object, string> _lazyLoader;

        public FixtureFunctionValue()
        {}

        public FixtureFunctionValue(Action<object,string> lazyLoader)
        {
